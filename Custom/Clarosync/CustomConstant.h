...
// Define option Brand
#define k_option_use_login_web                  YES
#define k_option_use_firebase                   YES
#define k_option_use_default_automatic_upload   YES

#define k_option_disable_intro                  YES
#define k_option_disable_request_login_url      NO
#define k_option_disable_multiaccount           YES
#define k_option_disable_cryptocloudsystem      YES
